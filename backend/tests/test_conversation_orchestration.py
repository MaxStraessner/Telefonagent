...
VALID_TRANSITIONS = [
    ...
    (BookingState.slot_available, BookingState.slot_rechecking),
    (BookingState.alternatives_available, BookingState.slot_rechecking),
    (BookingState.slot_rechecking, BookingState.customer_data_required),
    (BookingState.customer_data_required, BookingState.awaiting_confirmation),
    (BookingState.awaiting_confirmation, BookingState.final_check_running),
