...
def compile_agent_prompt(bundle: AgentBundle, greeting: str) -> str:
    ...
    sections = [
        ...
        _section(SECTION_NAMES[13], ([
            ...
            "Rufe list_bookable_services auf, statt Leistungen oder Terminarten zu erfinden.",
            "Rufe check_appointment_availability auf und verwende ausschließlich das serverseitige Ergebnis.",
            ...
            "Rufe create_appointment erst nach dieser ausdrücklichen Bestätigung mit confirmed=true auf.",
