...
export function AppointmentsPage() {
  return <DataPage>{(data) => <div className="page"><PageHeader eyebrow="Planung" title="Termine" description="Alle Termine des aktiven Unternehmens auf einen Blick." />
    <section className="card content-card">{data.appointments.length === 0 ? <EmptyState icon={<Icon name="calendar" size={28} />} title="Noch keine Testtermine vorhanden">Termine werden später über den Sprachagenten erstellt.</EmptyState> : <>
